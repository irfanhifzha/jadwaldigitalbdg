...
export default function BisdigEks24() {
    ...
    useEffect(() => {
    getDoc(doc(db, "kelas", "bisdigeks24")).then((snap) => {
        if (snap.exists()) {
            ...
            <div className="main-flex">
                <div className="card-container">
                    ...
                    <div className="card-content-header">
                        <h1>Dashboard Jadwal Kuliah - BISDIG EKS 24</h1>
                    </div>
                    <Dashboard />

                    {renderTable(`BISDIG EKS 24 - Semester ${semester} (${kategori}) / SKS ${sks_semesterini}`, Schedule)}
                </div>
            </div>
